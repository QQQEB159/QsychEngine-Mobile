...
class MusicPlayer extends FlxGroup 
{
	...
	var playingText:String = OeTools.getJsonData("Main", "musicplayer_playing");
	var pauseText:String = OeTools.getJsonData("Main", "musicplayer_paused");
	public var playingSongName:String = '';
	public var playingComposer:String = '';
	...
	override function update(elapsed:Float)
	{
		...
		if (playing && !wasPlaying)
			songTxt.text = playingText + playingSongName + " - " + playingComposer;
		else
			songTxt.text = playingText + playingSongName + " - " + playingComposer + " " + pauseText;
	...
	public function switchPlayMusic()
	{
		...
		if (playingMusic)
		{
			instance.bottomText.text = OeTools.getJsonData("Main", "musicplayer_tip");
			positionSong();
