...
class WeekData {
	...
	public static var needLoadSongPack:Array<String> = ['tutorial'];
	...
	public static function getWeekNum(week:String)
	{
		//trace(weeksList);
	...
	public static function cheakWeek(week:String):Bool
	{
